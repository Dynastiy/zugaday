...
var $upload = document.querySelector('#input_item')
...
var download = function download(dataUrl) {
  ...
  applyFilter(c)(f).then(function (res) {
    ...
    _fileSaver2.default.saveAs(f, "samzugaday.jpg");
  });
};
...
// Extract image dataUrl from Upload event
var processInput2 = function processInput2(e) {
	e.stopPropagation();
	e.preventDefault();
...
$upload.addEventListener('change', processInput2);

// Share Button
$share.addEventListener('click', ShareToFaceBook )
